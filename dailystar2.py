...
response = requests.get('https://www.ok.co.uk/lifestyle/charles-royal-coronation-key-roles-29235547', headers={ "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36" })
# print(response)
